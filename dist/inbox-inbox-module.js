...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("input[type=file] {\n  display: none;\n}\n\n.custom-file-upload {\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  display: inline-block;\n  padding: 6px 12px;\n  background-color: #009da0;\n  cursor: pointer;\n  color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var app_shared_services_config_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/shared/services/config.service */ "./src/app/shared/services/config.service.ts");
/* harmony import */ var app_forms_layouts_basic_api_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/forms/layouts/basic/api.service */ "./src/app/forms/layouts/basic/api.service.ts");
...
/* harmony import */ var ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ng2-jalali-date-picker */ "./node_modules/ng2-jalali-date-picker/ng2-jalali-date-picker.es5.js");
...
var InboxComponent = /** @class */ (function () {
    function InboxComponent(http, startcondate, endcondate, cookieService, api, elRef, renderer, modalService, inboxService, layoutService, configService) {
        var _this = this;
        this.http = http;
        this.startcondate = startcondate;
    ...
    InboxComponent.prototype.ngAfterViewInit = function () {
        ...
        this.api.getallContract(this.token_parts).subscribe(function (response1) {
            // console.log(response1[0])
            for (var i = 0; i < response1.length; i++) {
                var contract = response1[i]['title'];
                var start = "";
                var m = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(response1[i].start_date.toString());
                if (m.isValid()) {
                    m.locale('fa');
                ...
                var end = "";
                var m1 = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(response1[0].end_date.toString());
                if (m1.isValid()) {
                    m1.locale('fa');
    ...
    InboxComponent.prototype.DisplayMessage = function (event, planid, plant) {
        var _this = this;
        this.planti = plant;
        ...
        fetch("http://api.bimeh.plus/darman/getplandetail/", requestOptions)
            ...
            if (h.length != 0) {
                _this.plnselect = true;
                _this.plnselectn = false;
                for (var i = 0; i < h.length; i++) {
                    ...
                    _this.table.push({ svr: h[i]['svr'].toString(), subsvr: s, cov: c, fran: h[i]['fran'] });
                    _this.table = _this.table.slice(0);
                }
            }
            else {
                _this.plnselectn = true;
                _this.plnselect = false;
            }
        })
    ...
    //////// entakhab comboboxha ////////
    InboxComponent.prototype.getservs = function () {
        ...
        if (this.selectedsvr1.length < this.svrtable.length) {
            for (var j = 0; j < this.svrtable.length; j++) {
                var sf = true;
                for (var i = 0; i < this.selectedsvr1.length; i++) {
        ...
        for (var i = 0; i < this.selectedsvr1.length; i++) {
            ...
            if (!svrex) {
                for (var j = 0; j < this.servs.length; j++) {
                    if (this.servs[j].svrid == this.selectedsvr1[i]) {
                        var su = [];
                        for (var k = 0; k < this.servs[j].subsvr.length; k++) {
    ...
    InboxComponent.prototype.getValuesins = function () {
        //alert(this.insselected)
    };
    InboxComponent.prototype.getValuespln = function () {
        var perm = "";
        var plnid = [];
        var f = false;
        this.selectedflag = true;
        ...
        if (this.conplnselected.length < this.plntable.length) {
            for (var j = 0; j < this.plntable.length; j++) {
                var sf = true;
                for (var i = 0; i < this.conplnselected.length; i++) {
        ...
        for (var i = 0; i < this.conplnselected.length; i++) {
            ...
            if (!svrex) {
                for (var j = 0; j < this.allplans.length; j++) {
    ...
    /////////////////////////////////////
    ///////// sabt dar database /////////
    InboxComponent.prototype.plancreate = function () {
        var _this = this;
        // alert("Salam")
        ...
        this.api.getdatetime(this.token_parts).subscribe(function (response) {
            // console.log(response)
            var dtnow = response;
            var gdate = response.substring(0, 10);
            var timenow = response.substring(11, 19);
            var m = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(gdate);
            if (m.isValid()) {
                m.locale('fa');
            ...
            _this.api.createplan(_this.token_parts, plnn, dtnow, plnd, nid).subscribe(function (response) {
                var _loop_1 = function (i) {
                    _this.allplans.push({ id: response[0]['id'].toString(), title: plnn });
                    _this.allplans = _this.allplans.slice(0);
                    sid = _this.svrtable[i].svrid;
                    ca = _this.covval[i];
                    pid = response[0]['id'];
                    _this.api.createplansvr(_this.token_parts, pid, sid, ca).subscribe(function (response) {
                        for (var j = 0; j < _this.svrtable[i].subsvr.length; j++) {
                            console.log(_this.svrtable[i].subsvr[j]);
                            var subsvrid = _this.svrtable[i].subsvr[j].sub_id;
                            var subsvrf = false;
                            try {
                                subsvrf = _this.flagval[_this.svrtable[i].subsvr[j].sub_id];
                            }
                            catch (_a) {
                                subsvrf = false;
                            }
                            ...
                            _this.api.createplansubsvr(_this.token_parts, pid, subsvrid, subsvrf).subscribe(function (response) {
                ...
                var sid, ca, pid;
                for (var i = 0; i < _this.svrtable.length; i++) {
                    _loop_1(i);
                }
            }, function (err) { console.log(err); });
        });
    };
    InboxComponent.prototype.inscreate = function () {
        var _this = this;
        this.insprogress = 1;
        var formdata = new FormData();
        ...
        this.http.post("http://api.bimeh.plus/darman/createins/", formdata, {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(function (event) {
            if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpEventType"].UploadProgress) {
                _this.insprogress = Math.round((100 / event.total) * event.loaded);
            }
            else if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpEventType"].Response) {
                var res = event.body;
                var h = JSON.parse(res);
                console.log(h.id);
                _this.insurers.push({ id: h.id.toString(), name: h.name.toString() });
                _this.insurers = _this.insurers.slice(0);
                _this.insprogress = null;
            }
    ...
    InboxComponent.prototype.pwcreate = function () {
        var _this = this;
        this.insprogress = 1;
        var formdata = new FormData();
        ...
        formdata.append("last_insurer", this.insselected[0]);
        this.http.post("http://api.bimeh.plus/darman/createco/", formdata, {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(function (event) {
            if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpEventType"].UploadProgress) {
                _this.pwprogress = Math.round((100 / event.total) * event.loaded);
            }
            else if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpEventType"].Response) {
                var res = event.body;
                var h = JSON.parse(res);
                _this.companies.push({ id: h.id, name: h.name });
                _this.companies = _this.companies.slice(0);
                _this.pwprogress = null;
            }
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["catchError"])(function (err) {
            _this.insprogress = null;
            // alert(err.message);
    ...
    InboxComponent.prototype.contarctcreate = function () {
        var _this = this;
        // this.conttitle
        // this.contpwselected
        ...
        this.api.getPersonauth(this.token_parts).subscribe(function (response1) {
            ...
            _this.api.getdatetime(_this.token_parts).subscribe(function (response) {
                ...
                var m1 = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(_this.startcondate);
                if (m1.isValid()) {
                    m1.locale('en');
                ...
                var m2 = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(_this.endcondate);
                if (m2.isValid()) {
                    m2.locale('en');
                ...
                _this.contprogress = 1;
                var formdata = new FormData();
                formdata.append("title", _this.conttitle);
                formdata.append("policy_owner", _this.contpwselected);
                formdata.append("insurer", _this.continsselected);
                formdata.append("start_date", startdate);
                formdata.append("end_date", enddate);
                formdata.append("created_at", datenow);
                formdata.append("created_by", nid);
                formdata.append("contract_image", _this.contimage[0], _this.contimage[0].name);
                formdata.append("contract_number", _this.contno);
                //
                _this.http.post("http://api.bimeh.plus/darman/createcont/", formdata, {
                    headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpHeaders"]({
                    ...
                    if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpEventType"].UploadProgress) {
                        ...
                        for (var i = 0; i < _this.companies.length; i++) {
                            if (_this.companies[i].id == _this.contpwselected) {
                                pw1 = _this.companies[i].name;
                                break;
                            }
                        }
                        for (var i = 0; i < _this.insurers.length; i++) {
                            if (_this.insurers[i].id == _this.continsselected)
                                ins1 = _this.insurers[i].name;
                        }
                        var ms = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(h.start_date);
                        if (ms.isValid()) {
                            ms.locale('fa');
                        ...
                        var me = jalali_moment__WEBPACK_IMPORTED_MODULE_9__(h.end_date);
                        if (me.isValid()) {
                            me.locale('fa');
                        ...
                        _this.cons.push({ id: h.id, title: h.title, start: sdate, end: edate, pl: pw1, ins: ins1, img: h.contract_image });
                        _this.cons = _this.cons.slice(0);
                        _this.contprogress = null;
                        console.log(_this.plntable.length);
                        var _loop_2 = function (i) {
                            _this.api.getplandetail(_this.token_parts, _this.plntable[i]['id']).subscribe(function (response) {
                                var res = response;
                                for (var j = 0; j < res.length; j++) {
                                    for (var k = 0; k < res[j].subs.length; k++) {
                                        _this.api.createcps(_this.token_parts, h.id, _this.plntable[i]['id'], res[j].subs[k].subid).subscribe(function (response) { console.log("success"); }, function (err) { console.log("error"); });
                                    }
                                }
                            }, function (err) { console.log("error"); });
                            console.log(h.id);
                            console.log(_this.plntable[i]['id']);
                            console.log(_this.permium[i]);
                            console.log(_this.payduring[i]);
                            _this.api.createcontplan(_this.token_parts, h.id, _this.plntable[i]['id'], _this.permium[i], _this.payduring[i]).subscribe(function (response) {
                                console.log("success");
                            }, function (err) { console.log(err); });
                        };
                        for (var i = 0; i < _this.plntable.length; i++) {
                            _loop_2(i);
                        }
                    }
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["catchError"])(function (err) {
    ...
    InboxComponent.prototype.subsvrcreate = function () {
        var _this = this;
        var title = this.subsvrtitle;
        var des = this.subsvrdes;
        var svr = this.selectedsvrforsub;
        this.api.createsubsvr(this.token_parts, title, des, svr).subscribe(function (res) {
            var id = res.id;
            for (var i = 0; i < _this.servs.length; i++) {
                if (_this.servs[i].svrid == svr) {
                    _this.servs[i].subsvr.push({ sub_id: id, sub_title: title, sub_des: svr });
                    break;
                }
            }
        }, function (err) {
    ...
    InboxComponent.prototype.open = function (content) {
            ...
            if (!this.plnshow) {
                ...
                fetch("http://api.bimeh.plus/darman/getallservices/", requestOptions)
                    ...
                    if (h.length != 0) {
                        for (var i = 0; i < h.length; i++) {
                            var s = h[i]['subs'];
                            _this.servs.push({ svrid: h[i]['svr_id'].toString(), svr: h[i]['svr_title'].toString(), subsvr: s });
                            _this.servs = _this.servs.slice(0);
                        }
                    }
                    _this.plnshow = true;
                })
        ...
        if (page[0] == "content") {
            ...
            this.allplans = [];
            this.insurers = [];
            this.api.getallcom(this.token_parts).subscribe(function (responce) {
                for (var i = 0; i < responce.length; i++) {
                    _this.companies.push({ id: responce[i]['id'], name: responce[i]['name'] });
                    _this.companies = _this.companies.slice(0);
                }
            }, function (err) {
                console.error('refresh error', err);
            });
            this.api.getallplan(this.token_parts).subscribe(function (responce) {
                for (var i = 0; i < responce.length; i++) {
                    _this.allplans.push({ id: responce[i]['id'].toString(), title: responce[i]['title'].toString() });
                    _this.allplans = _this.allplans.slice(0);
                }
            }, function (err) {
                console.error('refresh error', err);
            });
            this.api.getallins(this.token_parts).subscribe(function (responce) {
                for (var i = 0; i < responce.length; i++) {
                    _this.insurers.push({ id: responce[i]['id'].toString(), name: responce[i]['name'].toString() });
                    _this.insurers = _this.insurers.slice(0);
                }
            }, function (err) {
                console.error('refresh error', err);
        ...
        this.modalService.open(content, ngbModalOptions).result.then(function (result) {
            ...
            if (page[0] == "content") {
                _this.conttitle = "";
                _this.contpwselected = "";
                _this.continsselected = "";
                _this.startcondate = "";
                _this.endcondate = "";
                _this.contimage = [];
                _this.contno = "";
    ...
    InboxComponent.prototype.GetEmailsByType = function (event, type) {
        ...
        this.plnselect = false;
        this.conselect = true;
        this.api.getplancon(this.token_parts, Number(type)).subscribe(function (response) {
            _this.conti = response[0]['contract__title'];
    ...
    InboxComponent.prototype.contSelectFile = function (event) {
        var _this = this;
        if (event.target.files && event.target.files[0]) {
            ...
            for (var i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function (event) {
                    _this.conturls.push(event.target.result);
                };
                reader.readAsDataURL(event.target.files[i]);
            }
        }
    };
    InboxComponent.prototype.insSelectFile = function (event) {
        var _this = this;
        if (event.target.files && event.target.files[0]) {
            var filesAmount = event.target.files.length;
            for (var i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function (event) {
                    _this.insurls.push(event.target.result);
                };
                reader.readAsDataURL(event.target.files[i]);
            }
        }
    };
    InboxComponent.prototype.pwSelectFile = function (event) {
        var _this = this;
        if (event.target.files && event.target.files[0]) {
            var filesAmount = event.target.files.length;
            for (var i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function (event) {
                    _this.pwurls.push(event.target.result);
                };
                reader.readAsDataURL(event.target.files[i]);
            }
        }
    ...
    InboxComponent.ctorParameters = function () { return [
        ...
        { type: ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_10__["DpDatePickerModule"] },
        { type: ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_10__["DpDatePickerModule"] },
        { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_8__["CookieService"] },
        { type: app_forms_layouts_basic_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiService"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] },
        { type: _inbox_service__WEBPACK_IMPORTED_MODULE_3__["InboxService"] },
        { type: app_shared_services_layout_service__WEBPACK_IMPORTED_MODULE_5__["LayoutService"] },
        { type: app_shared_services_config_service__WEBPACK_IMPORTED_MODULE_6__["ConfigService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], InboxComponent.prototype, "cValue", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    InboxComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClient"],
            ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_10__["DpDatePickerModule"],
            ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_10__["DpDatePickerModule"],
            ngx_cookie_service__WEBPACK_IMPORTED_MODULE_8__["CookieService"],
            app_forms_layouts_basic_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiService"],
            ...
            app_shared_services_layout_service__WEBPACK_IMPORTED_MODULE_5__["LayoutService"], app_shared_services_config_service__WEBPACK_IMPORTED_MODULE_6__["ConfigService"]])
    ], InboxComponent);
...
/* harmony import */ var ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng2-jalali-date-picker */ "./node_modules/ng2-jalali-date-picker/ng2-jalali-date-picker.es5.js");
/* harmony import */ var _inbox_routing_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./inbox-routing.module */ "./src/app/inbox/inbox-routing.module.ts");
/* harmony import */ var _inbox_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./inbox.component */ "./src/app/inbox/inbox.component.ts");
/* harmony import */ var app_shared_pipes_search_pipe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! app/shared/pipes/search.pipe */ "./src/app/shared/pipes/search.pipe.ts");
...
var InboxModule = /** @class */ (function () {
    ...
    InboxModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ng2_jalali_date_picker__WEBPACK_IMPORTED_MODULE_8__["DpDatePickerModule"],
                _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_3__["NgSelectModule"],
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _inbox_routing_module__WEBPACK_IMPORTED_MODULE_9__["InboxRoutingModule"],
            ...
            declarations: [
                _inbox_component__WEBPACK_IMPORTED_MODULE_10__["InboxComponent"],
                app_shared_pipes_search_pipe__WEBPACK_IMPORTED_MODULE_11__["SearchPipe"]
            ]
        })
    ], InboxModule);
    return InboxModule;
